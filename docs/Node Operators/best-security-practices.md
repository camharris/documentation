...
- [MINIMUM_CONTRACT_PAYMENT](../configuration-variables/#minimum_contract_payment): ensure your required payment amount is high enough to meet the costs of responding on-chain.
